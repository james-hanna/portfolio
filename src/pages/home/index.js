        ...
        <Zoom>
          ...
          >
            ...
            <div className="welcome-arrow-left-container">
              <img src={leftArrow} alt="left top arrow" className="leftArrow" />
            ...
            <div className="right-arrow-description-box">
                ...
                <img src={rightArrow} alt="right top arrow" className="rightArrow" />
            </div>

            <button onClick={() => gotItHandler()} className="got-it-button">I Got It</button>
